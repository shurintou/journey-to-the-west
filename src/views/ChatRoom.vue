  ...
  <el-container>
    ...
    <el-container>
      ...
      <el-main :style="{backgroundImage: 'url(' + mainImg + ')', padding: '0px 0px 0px 5px'}">
        ...
        <GameRoomModule v-else :playerLocRoom="playerLocRoom" :playerList="playerList" :isHorizontal="asideWidth !== '0px'" :tagSize="tagSize" :fontSize="fontSize"></GameRoomModule>
      </el-main>
      <el-footer :height="footHeight">
        <el-container class="fill-height">
            ...
            <PlayerInfoModule :subAsideWidth="subAsideWidth" :verticalBackground="verticalBackground" :fontSize="largeFontSize" :dialogWidth="dialogWidth" :playerInfoDialogWidth="playerInfoDialogWidth" :ws="ws"></PlayerInfoModule>
        </el-container>
      </el-footer>
    </el-container>
  </el-container>
