<template>
    <el-image
        :class="[avatarClass, { 'avatar_vibrate': vibrateFlag, 'heartbeat': heartbeatFlag, 'heartbeat_slow': heartbeatSlowFlag, 'heartbeat_fast': heartbeatFastFlag }]"
...
<style scoped>
.avatar_vibrate {
    -webkit-animation: avatar_vibrate .5s linear both;
    animation: avatar_vibrate .5s linear both
}

@-webkit-keyframes avatar_vibrate {
    0% {
...
.heartbeat_slow {
    -webkit-animation: heartbeat_slow 2s ease-in-out infinite both;
    animation: heartbeat_slow 2s ease-in-out infinite both
}

@-webkit-keyframes heartbeat_slow {
    from {
...
.heartbeat_fast {
    -webkit-animation: heartbeat_fast .5s ease-in-out infinite both;
    animation: heartbeat_fast .5s ease-in-out infinite both
}

@-webkit-keyframes heartbeat_fast {
    from {
        -webkit-transform: scale(1);
        transform: scale(1);
        -webkit-transform-origin: center center;
