<template>
    <el-row class="high-light" :class="{'award-background': rank < 4}" type="flex" align="middle" justify="center">
        ...
        <el-col :span="3">
            ...
            <span v-else :style="{'font-size' : fontSize, 'color' : rank < 4 ? 'white' : 'black'}" style="font-weight: 700;">第{{rank}}名</span>
        </el-col>
        <el-col :span="3">
        ...
        <el-col :span="12">
            <el-tag :style="{'font-size' : fontSize}" :type="tagDesign.type" :effect="tagDesign.effect">{{nickname}}</el-tag>
        </el-col>
        <el-col :span="4">
            <span :style="{'font-size' : fontSize, 'color' : rank < 4 ? 'white' : 'black'}" style="font-weight: 700; color: white">{{record}}</span>
        </el-col>
    </el-row>
</template>
